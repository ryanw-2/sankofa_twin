...
def simulate_next_humidity(
    ...
    passive_gain = 0.05 * (100 - internal_hum) if not is_venting and not is_heating else 0.0
...
def simulate_internal_temp(
    ...
    for i, row in forecast_df.iterrows():
        ...
        current_humidity = simulate_next_humidity(internal_humidity, ext_humidity, current_temp, heating, venting)
